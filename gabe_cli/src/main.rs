...
fn get_key_states(window: &Window, gb: &mut Gameboy) {
    gb.update_key_state(GbKeys::A, window.is_key_pressed(Key::X, KeyRepeat::No));
    gb.update_key_state(GbKeys::B, window.is_key_pressed(Key::Z, KeyRepeat::No));
    gb.update_key_state(GbKeys::Start, window.is_key_pressed(Key::Enter, KeyRepeat::No));
    gb.update_key_state(GbKeys::Select, window.is_key_pressed(Key::Backspace, KeyRepeat::No));
    gb.update_key_state(GbKeys::Up, window.is_key_pressed(Key::Up, KeyRepeat::No));
    gb.update_key_state(GbKeys::Down, window.is_key_pressed(Key::Down, KeyRepeat::No));
    gb.update_key_state(GbKeys::Left, window.is_key_pressed(Key::Left, KeyRepeat::No));
    gb.update_key_state(GbKeys::Right, window.is_key_pressed(Key::Right, KeyRepeat::No));
}
